...
var bjobterface = exports = module.exports = function(pngStream, options, faceCallback) {
    ...
    if (typeof faceCallback !== 'function') throw new Error('missing callback, expected as second argument to bjobterface');
