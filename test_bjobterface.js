...
const Bjobterface = require('./bjobterface.js');
const arDrone = require('ar-drone');
const client = arDrone.createClient();

const control = arDrone.createUdpControl();
const PNG = require('pngjs').PNG;
const PngServer = require('./PngServer');
const readline = require('readline');
const udpNavdatasStream = new client.createUdpNavdataStream();
...
const pngEncoder = client.getPngStream();
const videoStream = client.TcpVideoStream();
...
var bjobterface = Bjobterface(pngEncoder,{ outputImage:true  },function(info){
